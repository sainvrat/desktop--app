...
public class PChem implements ActionListener {
	JFrame f;
	JLabel l;
	...
	PChem(int a,String ss,String ss1,String ss2,String ss3,String ss4){
		f=new JFrame("Chemistry Questions");
		f.setSize(1350,750);
		f.setLayout(null);
		f.setVisible(true);
		...
		m.add(Box.createHorizontalGlue()); //m.add(mu5);  
		m.add(mu4);
		m.add(mu3);
	   ...
	   JMenuItem mic=new JMenuItem("Resume Quiz");
		...
		JMenuItem mi00=new JMenuItem("English");
	...
	public static void main(String args[]){
		 try
         {
             String s1; int i2=1;
              ...
              s1="select * from chemistry where QID=1";
		...
		new PChem(i2,ss,ss1,ss2,ss3,ss4);
	}
		 ...
		 try
        {
            String s1; 
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
              Statement s=con.createStatement();
             //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
             s1="select * from chemistry where QId=2";
		 ...
		 try
        {
            String s1; 
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
              Statement s=con.createStatement();
             //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
             s1="select * from chemistry where QId=3";
		 ...
		 try
        {
            String s1; 
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
              Statement s=con.createStatement();
             //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
             s1="select * from chemistry where QId=4";
		 ...
		 try
        {
            String s1; 
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
              Statement s=con.createStatement();
             //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
             s1="select * from chemistry where QId=5";
		 ...
		 try
       {
           String s1; 
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
             Statement s=con.createStatement();
            //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
            s1="select * from chemistry where QId=6";
		 ...
		 try
       {
           String s1; 
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
             Statement s=con.createStatement();
            //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
            s1="select * from chemistry where QId=7";
		 ...
		 try
       {
           String s1; 
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
             Statement s=con.createStatement();
            //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
            s1="select * from chemistry where QId=8";
		 ...
		 try
        {
            String s1; 
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
              Statement s=con.createStatement();
             //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
             s1="select * from chemistry where QId=9";
		 ...
		 try
        {
            String s1; 
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
              Statement s=con.createStatement();
             //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
             s1="select * from chemistry where QId=10";
