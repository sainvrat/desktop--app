...
public class Pphy implements ActionListener{
	JFrame f;
	JLabel l;
	...
	Pphy(int a,String ss,String ss1,String ss2,String ss3,String ss4){
		f=new JFrame("Physics Questions ");
		f.setSize(1350,750);
		f.setLayout(null);
		f.setVisible(true);
		...
		l.setBackground(new Color(136,251,32)); l.setOpaque(true); l.setLayout(null);
	   ...
	   JMenuItem mic=new JMenuItem("Resume Quiz");
		...
		JMenuItem mi02=new JMenuItem("English");
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource()==b1){
            ...
            try
            {
                String s1;
                 ...
                 ResultSet  rs1=s.executeQuery("select * from physics where QId="+i2);
                 while(rs1.next()){
                	 ii=rs1.getInt(7);
                 }
                 rs1.close();    s.close();
		...
		} }else {  JOptionPane.showMessageDialog(null,"You Have Submitted the Answer");
		b1.setVisible(false);
		}
            }
	...
	public static void main(String args[]){
		 try
         {
             String s1; int i2=1;
              ...
              s1="select * from physics where QId=1";
		...
		new Pphy(i2,ss,ss1,ss2,ss3,ss4);
	}
	...
	try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from physics where QId=2";
	...
	try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from physics where QId=3";
	...
	try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from physics where QId=4";
	...
	try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from physics where QId=5";
	...
	try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from physics where QId=6";
	...
	try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from physics where QId=7";
	...
	try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from physics where QId=8";
	...
	try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from physics where QId=9";
	...
	try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from physics where QId=10";
