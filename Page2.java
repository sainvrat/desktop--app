...
public class Page2 implements ActionListener{
	...
	Page2(int a,String ss,String ss1,String ss2,String ss3,String ss4){
		f=new JFrame("Page 2");
		f.setSize(1350,750);
		f.setLayout(null);
		f.setVisible(true);
		...
		l.setBackground(Color.white); l.setOpaque(true); l.setLayout(null);
		
		m=new JMenuBar();   m.setBounds(0, 0, 1350, 40);   m.setBackground(new Color(0,0,255));
		...
		m.add(mu6);  m.add(mu0);  m.add(mu1);m.add(mu2);
	   ...
	   JMenuItem mic=new JMenuItem("Resume Quiz");
		...
		JButton bq1=new JButton("Q11");      bq1.setBackground(Color.blue) ;  bq1.setForeground(Color.white);   bq1.setBounds(10, 10, 90, 80);  
		bq1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				
			}
		});
	    JButton bq2=new JButton("Q12");  	bq2.setBackground(Color.blue) ;  bq2.setForeground(Color.white);   bq2.setBounds(140,10, 100, 80);  
	    bq2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				
			}
		});
		JButton bq3=new JButton("Q13");      bq3.setBackground(Color.blue);   bq3.setForeground(Color.white);  bq3.setBounds(280, 10, 100, 80); 
		bq3.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				
			}
		});
		JButton bq4=new JButton("Q14");      bq4.setBackground(Color.blue);   bq4.setForeground(Color.white);   bq4.setBounds(420, 10, 100, 80); 
		bq4.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				
			}
		});
		JButton bq5=new JButton("Q15");      bq5.setBackground(Color.blue);  bq5.setForeground(Color.white);    bq5.setBounds(560, 10, 100, 80); 
		bq5.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				
			}
		});
		JButton bq6=new JButton("Q16");      bq6.setBackground(Color.blue);   bq6.setForeground(Color.white);   bq6.setBounds(700, 10, 100, 80); 
		bq6.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				
			}
		});
		JButton bq7=new JButton("Q17");      bq7.setBackground(Color.blue);   bq7.setForeground(Color.white);   bq7.setBounds(840, 10, 100, 80); 
		bq7.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				
			}
		});
		JButton bq8=new JButton("Q18");      bq8.setBackground(Color.blue);  bq8.setForeground(Color.white);   bq8.setBounds(980, 10, 100, 80); 
		bq8.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				
			}
		});
		JButton bq9=new JButton("Q19");      bq9.setBackground(Color.blue);  bq9.setForeground(Color.white);   bq9.setBounds(1120, 10, 100, 80); 
		bq9.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				
			}
		});
		JButton bq10=new JButton("Q20");    bq10.setBackground(Color.blue);  bq10.setForeground(Color.white); bq10.setBounds(1250, 10, 90, 80); 
		...
		l2.setBounds(100,150,1150,100);  l2.setFont(new Font("Serif",Font.BOLD,20));  l2.setForeground(Color.blue);
		l.add(l2);
		
		r1=new JRadioButton(ss1);           r2=new JRadioButton(ss2);
		r1.setBounds(50,300, 600, 50);    r2.setBounds(700, 300, 600, 50);
		l.add(r1);                       l.add(r2);
		r1.setBackground(Color.blue);     r2.setBackground(Color.blue);
		
		r3=new JRadioButton(ss3);           r4=new JRadioButton(ss4);
		r3.setBounds(50, 400, 600, 50);   r4.setBounds(700, 400, 600, 50);
		l.add(r3);                       l.add(r4);
		r3.setBackground(Color.blue);     r4.setBackground(Color.blue);
		...
		if(e.getSource()==b1){
            ...
            try
            {
                String s1;
                 ...
                 ResultSet  rs1=s.executeQuery("select * from gk where QId="+i2);
                 while(rs1.next()){
                	 ii=rs1.getInt(7);
                 }
                 rs1.close();    s.close();
             ...
             {    System.out.println(ex);     }
				...
				JOptionPane.showMessageDialog(null, "you have Submitted the value");  b1.setVisible(false);  }   }
			}
	...
	public static void main(String args[]){
		 try
         {
             String s1; 
              ...
              s1="select * from english where QID=11";
		...
		new Page2(i2,ss,ss1,ss2,ss3,ss4);
	}
