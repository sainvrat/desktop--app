...
public class main implements ActionListener {
	...
	main(int a,String ss,String ss1,String ss2,String ss3,String ss4){
		f=new JFrame("English Ouestions");
		f.setSize(1350,750);
		f.setLayout(null);
		f.setVisible(true);
		...
		l.setBackground(new Color(250,136,61)); l.setOpaque(true); l.setLayout(null);
	...
	if(e.getSource()==b1){
        ...
        try
        {
            String s1;
             ...
             ResultSet  rs1=s.executeQuery("select * from english where QId="+i2);
             while(rs1.next()){
            	 ii=rs1.getInt(7);
             }
             rs1.close();    s.close();
	...
	public static void main(String args[]){
		 try
         {
             String s1; 
              ...
              s1="select * from english where QId=1";
		...
		new main(i2,ss,ss1,ss2,ss3,ss4);
	}
		 ...
		 try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from english where QId=10";
		 ...
		 try
         {
             String s1;
              ...
              Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
               Statement s=con.createStatement();
              //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
              s1="select * from english where QId=9";
		 ...
		 try
        {
            String s1; 
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
              Statement s=con.createStatement();
             //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
             s1="select * from english where QId=8";
		 ...
		 try
        {
            String s1; 
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
              Statement s=con.createStatement();
             //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
             s1="select * from english where QId=7";
		 ...
		 try
        {
            String s1; 
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
              Statement s=con.createStatement();
             //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
             s1="select * from english where QId=6";
		 ...
		 try
        {
            String s1;
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
              Statement s=con.createStatement();
             //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
             s1="select * from english where QId=5";
	 ...
	 try
     {
         String s1; 
          ...
          Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
           Statement s=con.createStatement();
          //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
          s1="select * from english where QId=4";
		 ...
		 try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from english where QId=3";
		 ...
		 try
         {
             String s1; 
              ...
              Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
               Statement s=con.createStatement();
              //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
              s1="select * from english where QId=2";
