...
public class PEng implements ActionListener{JFrame f;
JLabel l;
...
PEng(int a,String ss,String ss1,String ss2,String ss3,String ss4){
	f=new JFrame("English Page2 Questions");
	f.setSize(1350,750);
	f.setLayout(null);
	f.setVisible(true);
	...
	if(e.getSource()==b1){
        ...
        try
        {
         ...
         {    System.out.println(ex);     } }   else { 
        	 JOptionPane.showMessageDialog(null, "You Submitted the value"); 
        	 b1.setVisible(false);}
                }   }
...
public static void main(String args[]){
	...
	new PEng(i2,ss,ss1,ss2,ss3,ss4);
}
