...
public class Pphy2 implements ActionListener{
	JFrame f;
	JLabel l;
	...
	Pphy2(int a,String ss,String ss1,String ss2,String ss3,String ss4){
		f=new JFrame("Physics Page2 Questions");
		f.setSize(1350,750);
		f.setLayout(null);
		f.setVisible(true);
	...
	public static void main(String args[]){
		 try
         {
             String s1; 
              ...
              s1="select * from physics where QID=11";
		...
		new Pphy2(i2,ss,ss1,ss2,ss3,ss4);
	}
