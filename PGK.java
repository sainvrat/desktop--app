...
public class PGK implements ActionListener {
	JFrame f;
	JLabel l;
	...
	PGK(int a,String ss,String ss1,String ss2,String ss3,String ss4){
		f=new JFrame("GK Questions :");
		f.setSize(1350,750);
		...
		l.setBackground(new Color(124,243,250)); l.setOpaque(true); l.setLayout(null);
	...
	public void actionPerformed(ActionEvent e){
		...
		else if(e.getSource()==b2){	int i=JOptionPane.showConfirmDialog(null, "Are you sure,You wants to leave this page");
	    if(i==0){
	    	new blank();
			f.setVisible(false);
		}
	 ...
	 else{	int i=JOptionPane.showConfirmDialog(null, "Are you sure,You wants to leave this page");
	    if(i==0){
	    	new Page2();
			f.setVisible(false);
		}
		 ...
		 try
    {
        String s1; 
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/QnlineQuiz", "root", "1234");
          Statement s=con.createStatement();
         //PreparedStatement ps = con.PreparedStatement("insert into reg values(?,?,?,?,?,?)");
         s1="select * from gk where QId=10";
